...
SACSCCs=SACSCCfunctions{end-1};
SACSCCs_rand=SACSCCfunctions{end-1}.rand;
...
%% Book-keeping
SACSCCfunctions{end}=SACSCCs;
if ~isnan(NumDrivenSpikes(2,1))
    SACSCCfunctions{end}.rand.PSDenv_A=SACSCCs_rand.PSDenv_A;
    SACSCCfunctions{end}.rand.PSDenv_B=SACSCCs_rand.PSDenv_B;
    SACSCCfunctions{end}.rand.PSDenv_C=SACSCCs_rand.PSDenv_C;
