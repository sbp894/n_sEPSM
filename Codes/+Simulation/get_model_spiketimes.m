function [SpikeTrains,paramsIN]=get_model_spiketimes(stim_S, stim_N, stim_SN, A, resultPostfix, C, AN, anal, resultsDir)
...
paramsIN.MAXdelay_sec=anal.maxDelaySec;  % sentence duration is 2.7 sec, so 1 sec delays are about 1/3 of stim duration, which is pushing what we can estimate

%% *MH July 7 2015 - change to longer delays to allow for lower modulations
paramsIN.FiberType=AN.fiberType.sr;
paramsIN.level=OALevel_dBSPL;
